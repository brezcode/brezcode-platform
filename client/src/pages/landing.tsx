        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.weeklyPlanning.title', 'Weekly planning')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.weeklyPlanning.description', 'Every Sunday you\'ll get a personalized plan for the week ahead. Pre-commit to your week ahead to crush your goals.')}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.community.title', 'Community')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.community.description', 'Give and get support in the vibrant BrezCode community, a place to cultivate a positive mindset every day.')}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.resources.title', 'Resources')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.resources.description', 'Exercises, videos, and resources are available on-demand to help you stay motivated when you need it.')}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.coaching.title', '24/7 Coaching')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.coaching.description', 'If you want any support or query, our AI coach trained by medical experts is always just a text message away, 24x7.')}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.tracking.title', 'Progress Tracking')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.tracking.description', 'Whether it\'s sleep, exercise, stress, or drinks cut, BrezCode shows you your progress in the terms that matter most to you.')}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg hover-lift">
              ...
              <h3 className="text-2xl font-bold mb-4">{t('appFeatures.alerts.title', 'Smart Alerts')}</h3>
              <p className="text-gray-600 leading-relaxed">
                {t('appFeatures.alerts.description', 'Tracking your drinks and diets will become the foundation of your habit change. BrezCode makes it simple and fun!')}
              </p>
            </div>
          </div>
        </div>
